...
func (c *noiseMonitoringAreServiceClient) CreateNoiseMonitoringArea(ctx context.Context, in *NoiseAreaCreate, opts ...grpc.CallOption) (*NoiseArea, error) {
	...
	out := new(NoiseArea)
	err := c.cc.Invoke(ctx, NoiseMonitoringAreService_CreateNoiseMonitoringArea_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *noiseMonitoringAreServiceClient) UpdateNoiseMonitoringArea(ctx context.Context, in *NoiseAreaCreate, opts ...grpc.CallOption) (*NoiseArea, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NoiseArea)
	err := c.cc.Invoke(ctx, NoiseMonitoringAreService_UpdateNoiseMonitoringArea_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *noiseMonitoringAreServiceClient) DeleteNoiseMonitoringArea(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, NoiseMonitoringAreService_DeleteNoiseMonitoringArea_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *noiseMonitoringAreServiceClient) GetNoiseMonitoringArea(ctx context.Context, in *ById, opts ...grpc.CallOption) (*NoiseArea, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NoiseArea)
	err := c.cc.Invoke(ctx, NoiseMonitoringAreService_GetNoiseMonitoringArea_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
