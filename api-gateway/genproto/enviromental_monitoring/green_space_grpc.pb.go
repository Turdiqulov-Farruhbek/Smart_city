...
func (c *greenSpaceServiceClient) CreateGreenSpace(ctx context.Context, in *GreenSpaceCreate, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, GreenSpaceService_CreateGreenSpace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greenSpaceServiceClient) GetGreenSpaces(ctx context.Context, in *GreenSpaceFilter, opts ...grpc.CallOption) (*GreenSpaceList, error) {
	...
	err := c.cc.Invoke(ctx, GreenSpaceService_GetGreenSpaces_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greenSpaceServiceClient) UpdateGreenSpace(ctx context.Context, in *GreenSpaceCreate, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, GreenSpaceService_UpdateGreenSpace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greenSpaceServiceClient) DeleteGreenSpace(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, GreenSpaceService_DeleteGreenSpace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
