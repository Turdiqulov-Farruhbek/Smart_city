...
func (c *plantRegistryServiceClient) RegisterPlants(ctx context.Context, in *PlantRegistry, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, PlantRegistryService_RegisterPlants_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *plantRegistryServiceClient) GetPlantRegistries(ctx context.Context, in *PlantRegistryFilter, opts ...grpc.CallOption) (*PlantRegistryList, error) {
	...
	err := c.cc.Invoke(ctx, PlantRegistryService_GetPlantRegistries_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *plantRegistryServiceClient) UpdatePlantRegistry(ctx context.Context, in *PlantRegistry, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, PlantRegistryService_UpdatePlantRegistry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *plantRegistryServiceClient) DeletePlantRegistry(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, PlantRegistryService_DeletePlantRegistry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
