...
type AirQualityReadingServiceClient interface {
	CreateAirQualityReading(ctx context.Context, in *AirQualityReading, opts ...grpc.CallOption) (*Void, error)
	GetCityWideAirQuality(ctx context.Context, in *Void, opts ...grpc.CallOption) (*AirQualityList, error)
...
func (c *airQualityReadingServiceClient) CreateAirQualityReading(ctx context.Context, in *AirQualityReading, opts ...grpc.CallOption) (*Void, error) {
...
func (c *airQualityReadingServiceClient) GetCityWideAirQuality(ctx context.Context, in *Void, opts ...grpc.CallOption) (*AirQualityList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AirQualityReadingServiceServer interface {
	CreateAirQualityReading(context.Context, *AirQualityReading) (*Void, error)
	GetCityWideAirQuality(context.Context, *Void) (*AirQualityList, error)
...
func (UnimplementedAirQualityReadingServiceServer) CreateAirQualityReading(context.Context, *AirQualityReading) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAirQualityReading not implemented")
}
func (UnimplementedAirQualityReadingServiceServer) GetCityWideAirQuality(context.Context, *Void) (*AirQualityList, error) {
...
func _AirQualityReadingService_CreateAirQualityReading_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AirQualityReadingServiceServer).CreateAirQualityReading(ctx, req.(*AirQualityReading))
	}
...
func _AirQualityReadingService_GetCityWideAirQuality_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AirQualityReadingServiceServer).GetCityWideAirQuality(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
