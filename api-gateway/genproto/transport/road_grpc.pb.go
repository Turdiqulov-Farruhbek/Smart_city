...
func (c *roadServiceClient) CreateRoad(ctx context.Context, in *RoadCreate, opts ...grpc.CallOption) (*Road, error) {
	...
	out := new(Road)
	err := c.cc.Invoke(ctx, RoadService_CreateRoad_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roadServiceClient) UpdateRoad(ctx context.Context, in *RoadCreate, opts ...grpc.CallOption) (*Road, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Road)
	err := c.cc.Invoke(ctx, RoadService_UpdateRoad_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roadServiceClient) DeleteRoad(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Road, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Road)
	err := c.cc.Invoke(ctx, RoadService_DeleteRoad_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roadServiceClient) GetRoad(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Road, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Road)
	err := c.cc.Invoke(ctx, RoadService_GetRoad_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
