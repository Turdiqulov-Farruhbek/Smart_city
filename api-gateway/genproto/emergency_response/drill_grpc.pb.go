...
func (c *emergencyDrillServiceClient) Create(ctx context.Context, in *DrillsCreateReq, opts ...grpc.CallOption) (*DrillsRes, error) {
	...
	out := new(DrillsRes)
	err := c.cc.Invoke(ctx, EmergencyDrillService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyDrillServiceClient) GetById(ctx context.Context, in *ById, opts ...grpc.CallOption) (*DrillsGetByIdRes, error) {
	...
	err := c.cc.Invoke(ctx, EmergencyDrillService_GetById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyDrillServiceClient) GetAll(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*DrillsGetAllRes, error) {
	...
	err := c.cc.Invoke(ctx, EmergencyDrillService_GetAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyDrillServiceClient) Update(ctx context.Context, in *DrillsUpdateReq, opts ...grpc.CallOption) (*DrillsRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DrillsRes)
	err := c.cc.Invoke(ctx, EmergencyDrillService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyDrillServiceClient) Delete(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, EmergencyDrillService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
