...
type EnenrgyMeterServiceClient interface {
	...
	UpdateEnergyMeter(ctx context.Context, in *EnergyMeterCreate, opts ...grpc.CallOption) (*EnergyMeter, error)
	DeleteEnergyMeter(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error)
	GetEnergyMeter(ctx context.Context, in *ById, opts ...grpc.CallOption) (*EnergyMeter, error)
}
...
func (c *enenrgyMeterServiceClient) CreateEnergyMeter(ctx context.Context, in *EnergyMeterCreate, opts ...grpc.CallOption) (*EnergyMeter, error) {
	out := new(EnergyMeter)
	err := c.cc.Invoke(ctx, EnenrgyMeterService_CreateEnergyMeter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enenrgyMeterServiceClient) UpdateEnergyMeter(ctx context.Context, in *EnergyMeterCreate, opts ...grpc.CallOption) (*EnergyMeter, error) {
	out := new(EnergyMeter)
	err := c.cc.Invoke(ctx, EnenrgyMeterService_UpdateEnergyMeter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enenrgyMeterServiceClient) DeleteEnergyMeter(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, EnenrgyMeterService_DeleteEnergyMeter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enenrgyMeterServiceClient) GetEnergyMeter(ctx context.Context, in *ById, opts ...grpc.CallOption) (*EnergyMeter, error) {
	out := new(EnergyMeter)
	err := c.cc.Invoke(ctx, EnenrgyMeterService_GetEnergyMeter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EnenrgyMeterServiceServer interface {
	...
	UpdateEnergyMeter(context.Context, *EnergyMeterCreate) (*EnergyMeter, error)
	DeleteEnergyMeter(context.Context, *ById) (*Void, error)
	GetEnergyMeter(context.Context, *ById) (*EnergyMeter, error)
...
func (UnimplementedEnenrgyMeterServiceServer) UpdateEnergyMeter(context.Context, *EnergyMeterCreate) (*EnergyMeter, error) {
...
func (UnimplementedEnenrgyMeterServiceServer) GetEnergyMeter(context.Context, *ById) (*EnergyMeter, error) {
...
func _EnenrgyMeterService_UpdateEnergyMeter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnenrgyMeterServiceServer).UpdateEnergyMeter(ctx, req.(*EnergyMeterCreate))
	}
	return interceptor(ctx, in, info, handler)
}
