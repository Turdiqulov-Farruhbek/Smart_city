...
func (c *cityZoneServiceClient) CreateCityZone(ctx context.Context, in *CityZoneCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CityZoneService_CreateCityZone_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cityZoneServiceClient) UpdateCityZone(ctx context.Context, in *CityZoneCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CityZoneService_UpdateCityZone_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cityZoneServiceClient) DeleteCityZone(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CityZoneService_DeleteCityZone_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cityZoneServiceClient) GetCityZone(ctx context.Context, in *CityZoneFilter, opts ...grpc.CallOption) (*CityZoneList, error) {
	...
	err := c.cc.Invoke(ctx, CityZoneService_GetCityZone_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
