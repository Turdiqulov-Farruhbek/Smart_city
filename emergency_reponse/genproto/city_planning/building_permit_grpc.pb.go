...
func (c *buildingPermitServiceClient) CreateBuildingPermit(ctx context.Context, in *BuildingPermitCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, BuildingPermitService_CreateBuildingPermit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildingPermitServiceClient) DeleteBuildingPermit(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, BuildingPermitService_DeleteBuildingPermit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildingPermitServiceClient) GetBuildingPermits(ctx context.Context, in *BuildingPermitFilter, opts ...grpc.CallOption) (*BuildingPermitFilter, error) {
	...
	err := c.cc.Invoke(ctx, BuildingPermitService_GetBuildingPermits_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildingPermitServiceClient) UpdateBuildingPermit(ctx context.Context, in *BuildingPermitCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, BuildingPermitService_UpdateBuildingPermit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
