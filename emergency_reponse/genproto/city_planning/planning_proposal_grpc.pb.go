...
func (c *planningProposalServiceClient) CreatePlanningProposal(ctx context.Context, in *PlanningProposalCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, PlanningProposalService_CreatePlanningProposal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *planningProposalServiceClient) GetPlanningProposals(ctx context.Context, in *PlanningProposalFilter, opts ...grpc.CallOption) (*PlanningProposalList, error) {
	...
	err := c.cc.Invoke(ctx, PlanningProposalService_GetPlanningProposals_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *planningProposalServiceClient) UpdatePlanningProposal(ctx context.Context, in *PlanningProposalCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, PlanningProposalService_UpdatePlanningProposal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *planningProposalServiceClient) DeletePlanningProposal(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, PlanningProposalService_DeletePlanningProposal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
