...
func (x *FilterType) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *FilterType) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *FilterType) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
var file_common_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x16, 0x0a, 0x04, 0x42, 0x79, 0x49, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x36, 0x0a, 0x06, 0x46, 0x69,
	...
	0x65, 0x74, 0x22, 0x4e, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65,
	...
	0x65, 0x74, 0x22, 0x06, 0x0a, 0x04, 0x56, 0x6f, 0x69, 0x64, 0x42, 0x1d, 0x5a, 0x1b, 0x67, 0x65,
...
var file_common_proto_goTypes = []interface{}{
	...
	(*FilterType)(nil), // 2: emergency_response.FilterType
	(*Void)(nil),       // 3: emergency_response.Void
}
