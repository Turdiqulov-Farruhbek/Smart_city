...
func (c *recyclingCenterServiceClient) CreateRecyclingCenter(ctx context.Context, in *RecyclingCenterCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, RecyclingCenterService_CreateRecyclingCenter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recyclingCenterServiceClient) UpdateRecyclingCenter(ctx context.Context, in *RecyclingCenterCreate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, RecyclingCenterService_UpdateRecyclingCenter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recyclingCenterServiceClient) DeleteRecyclingCenter(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, RecyclingCenterService_DeleteRecyclingCenter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recyclingCenterServiceClient) GetRecyclingCenters(ctx context.Context, in *RecyclingCenterFilter, opts ...grpc.CallOption) (*RecyclingCenterList, error) {
	...
	err := c.cc.Invoke(ctx, RecyclingCenterService_GetRecyclingCenters_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
