...
func (c *citizenNotificationServiceClient) SetNotificationPref(ctx context.Context, in *NotificationPref, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CitizenNotificationService_SetNotificationPref_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenNotificationServiceClient) UpdateNotificationPref(ctx context.Context, in *NotificationPref, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CitizenNotificationService_UpdateNotificationPref_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenNotificationServiceClient) DeleteNotificationPref(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CitizenNotificationService_DeleteNotificationPref_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
