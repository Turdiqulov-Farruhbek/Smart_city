...
func (c *citizenDocumentServiceClient) UploadDocument(ctx context.Context, in *DocumentCreate, opts ...grpc.CallOption) (*Document, error) {
	...
	out := new(Document)
	err := c.cc.Invoke(ctx, CitizenDocumentService_UploadDocument_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenDocumentServiceClient) GetCitizenDocuments(ctx context.Context, in *ById, opts ...grpc.CallOption) (*DocumentList, error) {
	...
	err := c.cc.Invoke(ctx, CitizenDocumentService_GetCitizenDocuments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CitizenDocumentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "city_submodule/citizen/document.proto",
}
