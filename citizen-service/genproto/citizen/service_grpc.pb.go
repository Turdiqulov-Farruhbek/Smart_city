...
func (c *citizenRequestServiceClient) CreateServiceRequest(ctx context.Context, in *ServiceReqCreate, opts ...grpc.CallOption) (*ServiceReq, error) {
	...
	out := new(ServiceReq)
	err := c.cc.Invoke(ctx, CitizenRequestService_CreateServiceRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenRequestServiceClient) GetCitizenRequests(ctx context.Context, in *ById, opts ...grpc.CallOption) (*ServiceReqList, error) {
	...
	err := c.cc.Invoke(ctx, CitizenRequestService_GetCitizenRequests_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenRequestServiceClient) UpdateServiceRequest(ctx context.Context, in *ServiceReqCreate, opts ...grpc.CallOption) (*ServiceReq, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceReq)
	err := c.cc.Invoke(ctx, CitizenRequestService_UpdateServiceRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *citizenRequestServiceClient) DeleteServiceRequest(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, CitizenRequestService_DeleteServiceRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CitizenRequestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "city_submodule/citizen/service.proto",
}
