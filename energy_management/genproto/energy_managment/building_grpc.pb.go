...
type BuildingServiceClient interface {
	...
	UpdateBuilding(ctx context.Context, in *BuildingUpdate, opts ...grpc.CallOption) (*Building, error)
...
func (c *buildingServiceClient) UpdateBuilding(ctx context.Context, in *BuildingUpdate, opts ...grpc.CallOption) (*Building, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Building)
...
func (c *buildingServiceClient) DeleteBuilding(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, BuildingService_DeleteBuilding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BuildingServiceServer interface {
	...
	UpdateBuilding(context.Context, *BuildingUpdate) (*Building, error)
...
func (UnimplementedBuildingServiceServer) UpdateBuilding(context.Context, *BuildingUpdate) (*Building, error) {
...
func _BuildingService_UpdateBuilding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BuildingServiceServer).UpdateBuilding(ctx, req.(*BuildingUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BuildingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "city_submodule/energy_management/building.proto",
}
