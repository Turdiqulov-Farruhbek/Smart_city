...
type MeterReadingServiceClient interface {
	...
	GetMeterReading(ctx context.Context, in *ById, opts ...grpc.CallOption) (*GetMeterReadingWithEnergy, error)
	UpdateMeterReading(ctx context.Context, in *MeterReadingUpdate, opts ...grpc.CallOption) (*Void, error)
...
func (c *meterReadingServiceClient) CreateMeterReading(ctx context.Context, in *MeterReading, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, MeterReadingService_CreateMeterReading_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meterReadingServiceClient) GetMeterReading(ctx context.Context, in *ById, opts ...grpc.CallOption) (*GetMeterReadingWithEnergy, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMeterReadingWithEnergy)
	err := c.cc.Invoke(ctx, MeterReadingService_GetMeterReading_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meterReadingServiceClient) UpdateMeterReading(ctx context.Context, in *MeterReadingUpdate, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, MeterReadingService_UpdateMeterReading_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meterReadingServiceClient) DeleteMeterReading(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, MeterReadingService_DeleteMeterReading_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meterReadingServiceClient) GetHourlyEnergyForBuilding(ctx context.Context, in *ByHour, opts ...grpc.CallOption) (*EnergyReportBuilding, error) {
	...
	err := c.cc.Invoke(ctx, MeterReadingService_GetHourlyEnergyForBuilding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meterReadingServiceClient) GetDailyEnergyForBuilding(ctx context.Context, in *ById, opts ...grpc.CallOption) (*EnergyReportBuilding, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EnergyReportBuilding)
	err := c.cc.Invoke(ctx, MeterReadingService_GetDailyEnergyForBuilding_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MeterReadingServiceServer interface {
	...
	GetMeterReading(context.Context, *ById) (*GetMeterReadingWithEnergy, error)
	UpdateMeterReading(context.Context, *MeterReadingUpdate) (*Void, error)
...
func (UnimplementedMeterReadingServiceServer) GetMeterReading(context.Context, *ById) (*GetMeterReadingWithEnergy, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMeterReading not implemented")
}
func (UnimplementedMeterReadingServiceServer) UpdateMeterReading(context.Context, *MeterReadingUpdate) (*Void, error) {
...
func _MeterReadingService_UpdateMeterReading_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeterReadingServiceServer).UpdateMeterReading(ctx, req.(*MeterReadingUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MeterReadingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "city_submodule/energy_management/meter_reading.proto",
}
