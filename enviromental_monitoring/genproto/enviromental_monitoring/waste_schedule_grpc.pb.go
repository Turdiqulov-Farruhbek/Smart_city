...
func (c *wasteCollectionServiceClient) CreateWasteCollectionSchedule(ctx context.Context, in *WasteCollectionScheduleCreate, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, WasteCollectionService_CreateWasteCollectionSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wasteCollectionServiceClient) UpdateWasteCollectionSchedule(ctx context.Context, in *WasteCollectionScheduleCreate, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, WasteCollectionService_UpdateWasteCollectionSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wasteCollectionServiceClient) DeleteWasteCollectionSchedule(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, WasteCollectionService_DeleteWasteCollectionSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wasteCollectionServiceClient) GetWasteCollectionSchedules(ctx context.Context, in *WasteScheduleFilter, opts ...grpc.CallOption) (*WasteScheduleList, error) {
	...
	err := c.cc.Invoke(ctx, WasteCollectionService_GetWasteCollectionSchedules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
