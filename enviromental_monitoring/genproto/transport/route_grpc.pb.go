...
func (c *routeServiceClient) CreateTransportRoute(ctx context.Context, in *RouteCreate, opts ...grpc.CallOption) (*Route, error) {
	...
	out := new(Route)
	err := c.cc.Invoke(ctx, RouteService_CreateTransportRoute_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routeServiceClient) GetAllTrasnportRoutes(ctx context.Context, in *RouteFilter, opts ...grpc.CallOption) (*RouteList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RouteList)
	err := c.cc.Invoke(ctx, RouteService_GetAllTrasnportRoutes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routeServiceClient) CreateSchedule(ctx context.Context, in *RouteScheduleCreate, opts ...grpc.CallOption) (*RouteSchedule, error) {
	...
	err := c.cc.Invoke(ctx, RouteService_CreateSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routeServiceClient) GetScheduleForRoute(ctx context.Context, in *ById, opts ...grpc.CallOption) (*RouteScheduleList, error) {
	...
	err := c.cc.Invoke(ctx, RouteService_GetScheduleForRoute_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
