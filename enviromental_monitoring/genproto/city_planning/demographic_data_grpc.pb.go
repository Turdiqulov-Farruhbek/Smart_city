...
func (c *demographicDataServiceClient) CreateDemographicData(ctx context.Context, in *DemographicDataCreate, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, DemographicDataService_CreateDemographicData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *demographicDataServiceClient) UpdateDemographicData(ctx context.Context, in *DemographicDataCreate, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, DemographicDataService_UpdateDemographicData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *demographicDataServiceClient) DeleteDemographicData(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, DemographicDataService_DeleteDemographicData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *demographicDataServiceClient) GetDemographicDatas(ctx context.Context, in *DemographicDataFilter, opts ...grpc.CallOption) (*DemographicDataList, error) {
	...
	err := c.cc.Invoke(ctx, DemographicDataService_GetDemographicDatas_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
