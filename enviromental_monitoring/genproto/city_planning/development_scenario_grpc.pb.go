...
func (c *developmentScenarioServiceClient) CreateScenario(ctx context.Context, in *ScenarioCreate, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, DevelopmentScenarioService_CreateScenario_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *developmentScenarioServiceClient) GetScenarios(ctx context.Context, in *ScenarioFilter, opts ...grpc.CallOption) (*ScenarioList, error) {
	...
	err := c.cc.Invoke(ctx, DevelopmentScenarioService_GetScenarios_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *developmentScenarioServiceClient) UpdateScenario(ctx context.Context, in *ScenarioCreate, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, DevelopmentScenarioService_UpdateScenario_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *developmentScenarioServiceClient) DeleteScenario(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, DevelopmentScenarioService_DeleteScenario_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
