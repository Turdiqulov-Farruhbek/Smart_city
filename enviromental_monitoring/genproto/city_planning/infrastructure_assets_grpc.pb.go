...
func (c *infrastuctureAssetServiceClient) CreateInfrastructureAsset(ctx context.Context, in *InfrastuctureAssetCreate, opts ...grpc.CallOption) (*Void, error) {
	...
	out := new(Void)
	err := c.cc.Invoke(ctx, InfrastuctureAssetService_CreateInfrastructureAsset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infrastuctureAssetServiceClient) UpdateInfrastructureAsset(ctx context.Context, in *InfrastuctureAssetCreate, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, InfrastuctureAssetService_UpdateInfrastructureAsset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infrastuctureAssetServiceClient) DeleteInfrastructureAsset(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, InfrastuctureAssetService_DeleteInfrastructureAsset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infrastuctureAssetServiceClient) GetInfrastructureAssets(ctx context.Context, in *InfrastuctureAssetFilter, opts ...grpc.CallOption) (*InfrastuctureAssetList, error) {
	...
	err := c.cc.Invoke(ctx, InfrastuctureAssetService_GetInfrastructureAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
